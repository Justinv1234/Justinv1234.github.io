...
import { UploadContact } from "../firebase/firebase";
...
const Contact = () => {
  ...
  const handleClick = async () => {
    ...
    await UploadContact(name, email, message);
  ...
  return (
    <div className="flex flex-col md:text-left text-center">
      ...
      <div className="flex justify-center">
        <button
          className="bg-gray-400 rounded-md mt-4 w-11/12 md:w-full px-4 py-2 text-white"
          onClick={handleClick}
        >
          Send Message
        </button>
